...
const refreshMedia = async () => {
  try {
    const htmlString = await axios.get('https://www.instagram.com/holy.molly.guacamolly')
    ...
    const mediaArr = mediaJson.entry_data.ProfilePage[0].graphql.user.edge_owner_to_timeline_media.edges;
